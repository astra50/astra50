...
ALTER SCHEMA audit OWNER TO astra50;
...
ALTER SCHEMA hdb_catalog OWNER TO astra50;
...
CREATE FUNCTION hdb_catalog."notify_hasura_gate_open_INSERT"() RETURNS trigger
  ...
  BEGIN
    IF TG_OP = 'UPDATE' THEN
      ...
      _new := row((SELECT  "e"  FROM  (SELECT  NEW."reason_id" , NEW."source" , NEW."created_at" , NEW."id" , NEW."gate_id" , NEW."comment" , NEW."updated_at" , NEW."person_id"        ) AS "e"      ) );
    ELSE
...
UPDATE member_payment
 ...
 WHERE member_payment.id = sub.id
   AND (member_payment.balance IS NULL OR member_payment.balance <> sub.balance);
$$;
...
CREATE TABLE public.land (
    ...
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    number_integer integer GENERATED ALWAYS AS ((number)::integer) STORED,
    coordinates point,
    polygon polygon
);
...
COMMENT ON TABLE public.land IS 'Земельные участки';
...
CREATE TABLE public.person (
    ...
    full_name text GENERATED ALWAYS AS (TRIM(BOTH FROM ((((COALESCE(lastname, ''::text) || ' '::text) || COALESCE(firstname, ''::text)) || ' '::text) || COALESCE(middlename, ''::text)))) STORED NOT NULL,
    user_id uuid
);
...
COMMENT ON TABLE public.person IS 'Члены СНТ';
...
COMMENT ON TABLE public.member_payment IS 'Членские взносы';
...
COMMENT ON COLUMN public.member_payment.is_regular IS 'Флаг автоматического начисления взносов';
...
COMMENT ON TABLE public.member_rate IS 'Ставка членских взносов';
...
CREATE VIEW public.payment_with_refinance_rate AS
 SELECT sub.date,
   ...
   FROM ( SELECT mp.paid_at AS date,
        ...
        UNION
         SELECT refinance_rate.since AS date,
            refinance_rate.rate,
            NULL::numeric AS "numeric",
            NULL::numeric AS "numeric",
            'ref_tax'::text AS text,
            NULL::uuid AS uuid
...
COMMENT ON TABLE public.street IS 'Улицы';
...
COMMENT ON TABLE public.target IS 'Статьи целевых взносов';
...
COMMENT ON COLUMN public.target.total_amount IS 'Целевая сумма';
...
COMMENT ON TABLE public.target_payment IS 'Целевые взносы';
...
CREATE TRIGGER add_person_to_account AFTER INSERT OR UPDATE OF person_id ON public.account FOR EACH ROW EXECUTE FUNCTION public.add_account_person_trigger_account();
...
CREATE TRIGGER audit_trigger_row AFTER INSERT OR DELETE OR UPDATE ON public.account FOR EACH ROW EXECUTE FUNCTION audit.if_modified_func('true');
...
CREATE TRIGGER audit_trigger_row AFTER INSERT OR DELETE OR UPDATE ON public.account_land FOR EACH ROW EXECUTE FUNCTION audit.if_modified_func('true');
...
CREATE TRIGGER audit_trigger_row AFTER INSERT OR DELETE OR UPDATE ON public.account_person FOR EACH ROW EXECUTE FUNCTION audit.if_modified_func('true');
...
CREATE TRIGGER audit_trigger_row AFTER INSERT OR DELETE OR UPDATE ON public.cctv FOR EACH ROW EXECUTE FUNCTION audit.if_modified_func('true');
...
CREATE TRIGGER audit_trigger_row AFTER INSERT OR DELETE OR UPDATE ON public.contact FOR EACH ROW EXECUTE FUNCTION audit.if_modified_func('true');
...
CREATE TRIGGER audit_trigger_row AFTER INSERT OR DELETE OR UPDATE ON public.gate FOR EACH ROW EXECUTE FUNCTION audit.if_modified_func('true');
...
CREATE TRIGGER audit_trigger_row AFTER INSERT OR DELETE OR UPDATE ON public.gate_open FOR EACH ROW EXECUTE FUNCTION audit.if_modified_func('true');
...
CREATE TRIGGER audit_trigger_row AFTER INSERT OR DELETE OR UPDATE ON public.gate_open_reason FOR EACH ROW EXECUTE FUNCTION audit.if_modified_func('true');
...
CREATE TRIGGER audit_trigger_row AFTER INSERT OR DELETE OR UPDATE ON public.land FOR EACH ROW EXECUTE FUNCTION audit.if_modified_func('true');
...
CREATE TRIGGER audit_trigger_row AFTER INSERT OR DELETE OR UPDATE ON public.member_discount FOR EACH ROW EXECUTE FUNCTION audit.if_modified_func('true');
...
CREATE TRIGGER audit_trigger_row AFTER INSERT OR DELETE OR UPDATE ON public.member_payment FOR EACH ROW EXECUTE FUNCTION audit.if_modified_func('true');
...
CREATE TRIGGER audit_trigger_row AFTER INSERT OR DELETE OR UPDATE ON public.member_rate FOR EACH ROW EXECUTE FUNCTION audit.if_modified_func('true');
...
CREATE TRIGGER audit_trigger_row AFTER INSERT OR DELETE OR UPDATE ON public.person FOR EACH ROW EXECUTE FUNCTION audit.if_modified_func('true');
...
CREATE TRIGGER audit_trigger_row AFTER INSERT OR DELETE OR UPDATE ON public.person_email FOR EACH ROW EXECUTE FUNCTION audit.if_modified_func('true');
...
CREATE TRIGGER audit_trigger_row AFTER INSERT OR DELETE OR UPDATE ON public.person_phone FOR EACH ROW EXECUTE FUNCTION audit.if_modified_func('true');
...
CREATE TRIGGER audit_trigger_row AFTER INSERT OR DELETE OR UPDATE ON public.personal_access_token FOR EACH ROW EXECUTE FUNCTION audit.if_modified_func('true');
...
CREATE TRIGGER audit_trigger_row AFTER INSERT OR DELETE OR UPDATE ON public.refinance_rate FOR EACH ROW EXECUTE FUNCTION audit.if_modified_func('true');
...
CREATE TRIGGER audit_trigger_row AFTER INSERT OR DELETE OR UPDATE ON public.street FOR EACH ROW EXECUTE FUNCTION audit.if_modified_func('true');
...
CREATE TRIGGER audit_trigger_row AFTER INSERT OR DELETE OR UPDATE ON public.target FOR EACH ROW EXECUTE FUNCTION audit.if_modified_func('true');
...
CREATE TRIGGER audit_trigger_row AFTER INSERT OR DELETE OR UPDATE ON public.target_payment FOR EACH ROW EXECUTE FUNCTION audit.if_modified_func('true');
...
CREATE TRIGGER audit_trigger_stm AFTER TRUNCATE ON public.account FOR EACH STATEMENT EXECUTE FUNCTION audit.if_modified_func('true');
...
CREATE TRIGGER audit_trigger_stm AFTER TRUNCATE ON public.account_land FOR EACH STATEMENT EXECUTE FUNCTION audit.if_modified_func('true');
...
CREATE TRIGGER audit_trigger_stm AFTER TRUNCATE ON public.account_person FOR EACH STATEMENT EXECUTE FUNCTION audit.if_modified_func('true');
...
CREATE TRIGGER audit_trigger_stm AFTER TRUNCATE ON public.cctv FOR EACH STATEMENT EXECUTE FUNCTION audit.if_modified_func('true');
...
CREATE TRIGGER audit_trigger_stm AFTER TRUNCATE ON public.contact FOR EACH STATEMENT EXECUTE FUNCTION audit.if_modified_func('true');
...
CREATE TRIGGER audit_trigger_stm AFTER TRUNCATE ON public.gate FOR EACH STATEMENT EXECUTE FUNCTION audit.if_modified_func('true');
...
CREATE TRIGGER audit_trigger_stm AFTER TRUNCATE ON public.gate_open FOR EACH STATEMENT EXECUTE FUNCTION audit.if_modified_func('true');
...
CREATE TRIGGER audit_trigger_stm AFTER TRUNCATE ON public.gate_open_reason FOR EACH STATEMENT EXECUTE FUNCTION audit.if_modified_func('true');
...
CREATE TRIGGER audit_trigger_stm AFTER TRUNCATE ON public.land FOR EACH STATEMENT EXECUTE FUNCTION audit.if_modified_func('true');
...
CREATE TRIGGER audit_trigger_stm AFTER TRUNCATE ON public.member_discount FOR EACH STATEMENT EXECUTE FUNCTION audit.if_modified_func('true');
...
CREATE TRIGGER audit_trigger_stm AFTER TRUNCATE ON public.member_payment FOR EACH STATEMENT EXECUTE FUNCTION audit.if_modified_func('true');
...
CREATE TRIGGER audit_trigger_stm AFTER TRUNCATE ON public.member_rate FOR EACH STATEMENT EXECUTE FUNCTION audit.if_modified_func('true');
...
CREATE TRIGGER audit_trigger_stm AFTER TRUNCATE ON public.person FOR EACH STATEMENT EXECUTE FUNCTION audit.if_modified_func('true');
...
CREATE TRIGGER audit_trigger_stm AFTER TRUNCATE ON public.person_email FOR EACH STATEMENT EXECUTE FUNCTION audit.if_modified_func('true');
...
CREATE TRIGGER audit_trigger_stm AFTER TRUNCATE ON public.person_phone FOR EACH STATEMENT EXECUTE FUNCTION audit.if_modified_func('true');
...
CREATE TRIGGER audit_trigger_stm AFTER TRUNCATE ON public.personal_access_token FOR EACH STATEMENT EXECUTE FUNCTION audit.if_modified_func('true');
...
CREATE TRIGGER audit_trigger_stm AFTER TRUNCATE ON public.refinance_rate FOR EACH STATEMENT EXECUTE FUNCTION audit.if_modified_func('true');
...
CREATE TRIGGER audit_trigger_stm AFTER TRUNCATE ON public.street FOR EACH STATEMENT EXECUTE FUNCTION audit.if_modified_func('true');
...
CREATE TRIGGER audit_trigger_stm AFTER TRUNCATE ON public.target FOR EACH STATEMENT EXECUTE FUNCTION audit.if_modified_func('true');
...
CREATE TRIGGER audit_trigger_stm AFTER TRUNCATE ON public.target_payment FOR EACH STATEMENT EXECUTE FUNCTION audit.if_modified_func('true');
...
CREATE TRIGGER gate_open_find_person_id BEFORE INSERT ON public.gate_open FOR EACH ROW EXECUTE FUNCTION public.gate_open_find_person_id();
...
CREATE TRIGGER gate_open_set_person_on_email AFTER INSERT OR UPDATE OF email, person_id ON public.person_email FOR EACH ROW EXECUTE FUNCTION public.gate_open_set_person_on_email();
...
CREATE TRIGGER gate_open_set_person_on_phone AFTER INSERT OR UPDATE OF phone, person_id ON public.person_phone FOR EACH ROW EXECUTE FUNCTION public.gate_open_set_person_on_phone();
...
CREATE TRIGGER gate_open_set_person_on_telegram_id AFTER INSERT OR UPDATE OF telegram_id ON public.person FOR EACH ROW EXECUTE FUNCTION public.gate_open_set_person_on_telegram_id();
...
CREATE TRIGGER "notify_hasura_gate_open_INSERT" AFTER INSERT ON public.gate_open FOR EACH ROW EXECUTE FUNCTION hdb_catalog."notify_hasura_gate_open_INSERT"();
...
CREATE TRIGGER set_account_balance AFTER INSERT OR DELETE OR UPDATE OF amount, account_id ON public.member_payment FOR EACH ROW EXECUTE FUNCTION public.account_trigger_balance();
...
CREATE TRIGGER set_person_balance AFTER UPDATE OF balance ON public.account FOR EACH ROW EXECUTE FUNCTION public.person_balance_trigger_account();
...
CREATE TRIGGER set_person_balance AFTER INSERT OR DELETE OR UPDATE OF account_id, person_id ON public.account_person FOR EACH ROW EXECUTE FUNCTION public.person_balance_trigger_account_person();
...
CREATE TRIGGER set_person_email_is_main_to_false BEFORE INSERT OR UPDATE OF is_main ON public.person_email FOR EACH ROW EXECUTE FUNCTION public.set_person_email_is_main_to_false();
...
CREATE TRIGGER set_person_last_payment AFTER INSERT OR DELETE OR UPDATE OF account_id, amount, paid_at ON public.member_payment FOR EACH ROW EXECUTE FUNCTION public.person_last_paid_trigger_member_payment();
...
CREATE TRIGGER set_person_phone_is_main_to_false BEFORE INSERT OR UPDATE OF is_main ON public.person_phone FOR EACH ROW EXECUTE FUNCTION public.set_person_phone_is_main_to_false();
...
CREATE TRIGGER set_target_amount AFTER INSERT OR UPDATE OF amount, target_id ON public.target_payment FOR EACH ROW EXECUTE FUNCTION public.set_target_amount();
...
CREATE TRIGGER set_updated_at BEFORE UPDATE ON public.account FOR EACH ROW EXECUTE FUNCTION public.set_current_timestamp_updated_at();
...
CREATE TRIGGER set_updated_at BEFORE UPDATE ON public.account_land FOR EACH ROW EXECUTE FUNCTION public.set_current_timestamp_updated_at();
...
CREATE TRIGGER set_updated_at BEFORE UPDATE ON public.account_person FOR EACH ROW EXECUTE FUNCTION public.set_current_timestamp_updated_at();
...
CREATE TRIGGER set_updated_at BEFORE UPDATE ON public.cctv FOR EACH ROW EXECUTE FUNCTION public.set_current_timestamp_updated_at();
...
CREATE TRIGGER set_updated_at BEFORE UPDATE ON public.contact FOR EACH ROW EXECUTE FUNCTION public.set_current_timestamp_updated_at();
...
CREATE TRIGGER set_updated_at BEFORE UPDATE ON public.contractor FOR EACH ROW EXECUTE FUNCTION public.set_current_timestamp_updated_at();
...
CREATE TRIGGER set_updated_at BEFORE UPDATE ON public.gate FOR EACH ROW EXECUTE FUNCTION public.set_current_timestamp_updated_at();
...
CREATE TRIGGER set_updated_at BEFORE UPDATE ON public.gate_open FOR EACH ROW EXECUTE FUNCTION public.set_current_timestamp_updated_at();
...
CREATE TRIGGER set_updated_at BEFORE UPDATE ON public.gate_open_reason FOR EACH ROW EXECUTE FUNCTION public.set_current_timestamp_updated_at();
...
CREATE TRIGGER set_updated_at BEFORE UPDATE ON public.land FOR EACH ROW EXECUTE FUNCTION public.set_current_timestamp_updated_at();
...
CREATE TRIGGER set_updated_at BEFORE UPDATE ON public.member_discount FOR EACH ROW EXECUTE FUNCTION public.set_current_timestamp_updated_at();
...
CREATE TRIGGER set_updated_at BEFORE UPDATE ON public.member_payment FOR EACH ROW EXECUTE FUNCTION public.set_current_timestamp_updated_at();
...
CREATE TRIGGER set_updated_at BEFORE UPDATE ON public.member_rate FOR EACH ROW EXECUTE FUNCTION public.set_current_timestamp_updated_at();
...
CREATE TRIGGER set_updated_at BEFORE UPDATE ON public.person FOR EACH ROW EXECUTE FUNCTION public.set_current_timestamp_updated_at();
...
CREATE TRIGGER set_updated_at BEFORE UPDATE ON public.person_email FOR EACH ROW EXECUTE FUNCTION public.set_current_timestamp_updated_at();
...
CREATE TRIGGER set_updated_at BEFORE UPDATE ON public.person_phone FOR EACH ROW EXECUTE FUNCTION public.set_current_timestamp_updated_at();
...
CREATE TRIGGER set_updated_at BEFORE UPDATE ON public.personal_access_token FOR EACH ROW EXECUTE FUNCTION public.set_current_timestamp_updated_at();
...
CREATE TRIGGER set_updated_at BEFORE UPDATE ON public.refinance_rate FOR EACH ROW EXECUTE FUNCTION public.set_current_timestamp_updated_at();
...
CREATE TRIGGER set_updated_at BEFORE UPDATE ON public.street FOR EACH ROW EXECUTE FUNCTION public.set_current_timestamp_updated_at();
...
CREATE TRIGGER set_updated_at BEFORE UPDATE ON public.target FOR EACH ROW EXECUTE FUNCTION public.set_current_timestamp_updated_at();
...
CREATE TRIGGER set_updated_at BEFORE UPDATE ON public.target_payment FOR EACH ROW EXECUTE FUNCTION public.set_current_timestamp_updated_at();
...
CREATE TRIGGER update_balance AFTER INSERT OR UPDATE OF amount, account_id, paid_at ON public.member_payment FOR EACH ROW EXECUTE FUNCTION public.calculate_member_payment_balance();
...
ALTER TABLE ONLY public.account_land
    ADD CONSTRAINT account_land_account_id_fkey FOREIGN KEY (account_id) REFERENCES public.account(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.account_person
    ADD CONSTRAINT account_person_account_id_fkey FOREIGN KEY (account_id) REFERENCES public.account(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.account_person
    ADD CONSTRAINT account_person_person_id_fkey FOREIGN KEY (person_id) REFERENCES public.person(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.gate
    ADD CONSTRAINT gate_cctv_id_fkey FOREIGN KEY (cctv_id) REFERENCES public.cctv(id) ON UPDATE CASCADE ON DELETE SET NULL;
...
ALTER TABLE ONLY public.land
    ADD CONSTRAINT land_street_id_fkey FOREIGN KEY (street_id) REFERENCES public.street(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.member_discount
    ADD CONSTRAINT member_discount_account_id_fkey FOREIGN KEY (account_id) REFERENCES public.account(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.member_discount
    ADD CONSTRAINT member_discount_rate_id_fkey FOREIGN KEY (rate_id) REFERENCES public.member_rate(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.member_payment
    ADD CONSTRAINT member_payment_land_id_fkey FOREIGN KEY (land_id) REFERENCES public.land(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.member_payment
    ADD CONSTRAINT member_payment_person_id_fkey FOREIGN KEY (person_id) REFERENCES public.person(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.member_payment
    ADD CONSTRAINT member_payment_rate_id_fkey FOREIGN KEY (rate_id) REFERENCES public.member_rate(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.person
    ADD CONSTRAINT person_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON UPDATE CASCADE ON DELETE SET NULL;
...
ALTER TABLE ONLY public.personal_access_token
    ADD CONSTRAINT personal_access_token_person_id_fkey FOREIGN KEY (person_id) REFERENCES public.person(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY public.target_payment
    ADD CONSTRAINT target_payment_land_id_fkey FOREIGN KEY (land_id) REFERENCES public.land(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.target_payment
    ADD CONSTRAINT target_payment_person_id_fkey FOREIGN KEY (person_id) REFERENCES public.person(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
