...
SELECT audit.audit_table('public.land');
SELECT audit.audit_table('public.land_ownership');
SELECT audit.audit_table('public.member_payment');
SELECT audit.audit_table('public.member_rate');
SELECT audit.audit_table('public.person');
SELECT audit.audit_table('public.street');
SELECT audit.audit_table('public.target');
SELECT audit.audit_table('public.target_payment');
